...
class CustomLunarLander_v1(LunarLander):
    def reset(self,
        *,
        ...
        """
        # task: We're using Polymorphism to customize our lunarlander.
                After changing the LANDER_POLY of the lunar lander,
                we need <reset> function to excute the new shape of the lunar lander.
                And we've done it but empty the previous reset function.
                So, you need to complete the previous <reset> function.
